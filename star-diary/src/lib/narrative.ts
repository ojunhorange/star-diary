...
- myth (800~1,100자): 신화를 처음부터 끝까지 이야기로만 씁니다. 여기서는 일기를 인용하지 않습니다. 마지막 문단은 별자리가 하늘에 어떻게 남았는지로 끝냅니다.
- lesson (40자 이내): 표면적 교훈 한 줄. 접두어 없이 문장만.
...
- action (250~400자): 언제·어디서·무엇을 명시한 행동 1개. "행동의 형태"를 이 사람의 일기 속 장면에 맞춰 구체화합니다. 아주 작게. 마지막 문장은 신화와 연결.
