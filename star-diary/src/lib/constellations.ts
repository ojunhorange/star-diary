...
const RAW: Sky[] = [
  ...
  { // 처녀: 스피카와 Y자 — 핵심 γ Porrima, α Spica, ζ Heze
    id: "virgo", profile: { O: 0, C: 0, E: -2, A: -1, N: 1 }, nFacet: "취약성",
    stars: [[12.694, -1.45], [13.42, -11.16], [13.578, -0.6], [12.927, 3.4], [13.036, 10.96], [12.332, -0.67], [11.845, 1.76]],
    edges: [[6, 5], [5, 0], [0, 3], [3, 4], [0, 1], [1, 2], [2, 3]],
  },
